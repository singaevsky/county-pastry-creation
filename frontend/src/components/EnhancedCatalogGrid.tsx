                ...
                <div className="flex-1 flex flex-col justify-center">
                  <div className="text-center mb-8">
                    ...
                    <div className="flex justify-center items-center gap-4 mt-4">
                      <div className="flex items-center gap-1">
                        ...
                        <span className="text-sm font-medium text-blue-800">{mainProduct.rating}</span>
                      </div>
                      <div className="flex items-center gap-1">
                        <Clock className="h-4 w-4 text-blue-600" />
                        <span className="text-sm text-blue-700">{mainProduct.prepTime}ч</span>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="text-center">
                    ...
                    <div className="flex justify-center gap-4">
                      ...
                      >
                        <Heart className={`mr-2 h-5 w-5 ${favorites.has(mainProduct.id) ? 'fill-red-500 text-red-500' : ''}`} />
                      </Button>
                    </div>
                  </div>
                </div>
                  ...
                  <div className="text-center">
                    ...
                    <div className="flex justify-center gap-1">
                      ...
                      <Button 
                        variant="outline" 
                        size="sm"
                        className={`h-8 px-2 border-white/50 transition-all duration-300 ${
...
export default EnhancedCatalogGrid;
